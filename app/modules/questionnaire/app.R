here::i_am("app/modules/questionnaire/app.R")
data_directory <- here::here('app_skeleton','Inputs') #define relative path to your questionnaire app directory
questions_df <- read.csv(here::here(data_directory,"questions.csv"))
